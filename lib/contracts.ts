import { VAULT_ABI, STAKING_ABI, ROUTER_ABI, PAIR_ABI, LYM_ABI } from "./abis";
...
export const LYM_ADDRESS     = process.env.NEXT_PUBLIC_LYM_ADDRESS     as `0x${string}`;
...
export const LYM_CONTRACT     = { address: LYM_ADDRESS,     abi: LYM_ABI     } as const;
