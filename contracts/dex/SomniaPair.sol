...
contract SomniaPair is IERC20 {
    ...
    // ERC-20
    string  public constant name     = "Lymitra LP Token";
    string  public constant symbol   = "LLP";
    ...
    function _burn(address from, uint256 value) internal { balanceOf[from] -= value; totalSupply -= value; emit Transfer(from, address(0), value); }
